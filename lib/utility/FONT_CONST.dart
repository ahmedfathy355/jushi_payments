...
class FONT_CONST {
  ...
  static final OSWALD_REGULAR_RED2_22 =
  OSWALD_REGULAR_RED2.copyWith(fontSize: 22);

  static final OSWALD_REGULAR_Green_22 =
  OSWALD_REGULAR.copyWith(color: COLOR_CONST.GREEN2,fontSize: 22  );
}
